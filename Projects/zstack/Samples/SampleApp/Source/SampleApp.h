...
#define SAMPLEAPP_SEND_PERIODIC_MSG_TIMEOUT   1500     // Every 1.5 seconds

// Application Events (OSAL) - These are bit weighted definitions.
#define SAMPLEAPP_SEND_PERIODIC_MSG_EVT       0x0001
#define SAMPLEAPP_LCD_DISPLAY_EVT             0x0008
#define SAMPLEAPP_TIME_SEC_EVT                0x0004
#define SAMPLEAPP_CHECK_ALIVE_EVT             0x0010
